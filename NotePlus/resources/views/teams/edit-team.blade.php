        ...
        <div class="mx-auto max-w-7xl px-4 py-4 sm:px-6 lg:px-8 mt-5">
              ...
              @endif
                <div class="sm:mx-auto sm:w-full sm:max-w-sm">
                    <h2 class="mt-10 text-center text-2xl/9 font-bold tracking-tight text-gray-900">Update Your Team Profile</h2>
                </div>
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                <form class="space-y-6" action="{{ route('teams.update', $team->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                  <div>
                    <label for="team_name" class="block text-sm/6 font-medium text-gray-900">Team Name</label>
                    <div class="mt-2">
                      <input type="text" name="team_name" id="team_name" autocomplete="team_name" value="{{ $team->team_name }}" required class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6" />
                    </div>
                    @error('team_name')
                  ...
                  <div class="flex justify-between">
                    <button type="button" class="flex rounded-md bg-gray-900 px-3 py-1.5 text-sm/6 font-semibold shadow-xs focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-500">
                        <a class="text-white hover:bg-gray-800" href="{{ route('teams.index') }}" class="font-semibold text-gray-600 hover:text-gray-500">
                            Cancel
                        </a>
                    </button>
                    <button type="submit" class="flex rounded-md bg-indigo-600 px-1 py-1.5 text-sm/6 font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Update</button>
                  </div>
                </form>
          </div>
        </div>

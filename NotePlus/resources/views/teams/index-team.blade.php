...
<div class="min-h-full">
 ...
 <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
    <p class="font-bold text-2xl">All Teams</p>
 </div>
        ...
        <div class="bg-gray-300 rounded-xl shadow hover:bg-gray-100 transition duration-300">
            ...
            <div class="p-4 ">
              ...
              <div class="flex justify-between items-center text-sm text-gray-500">
                <div class="space-x-2">
                  <button class="px-3 py-1 border rounded text-sm bg-blue-600 text-white hover:bg-gray-200 hover:text-black"><a href="{{ route('teams.show', $team->id) }}">Open</a></button>
                  <button class="px-3 py-1 border rounded text-sm hover:bg-gray-900"><a href="{{ route('teams.edit', $team->id) }}">Edit</a></button>
                  <form class="inline" action="{{ route('teams.destroy', $team->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this note?');">
                    @csrf
                    @method('DELETE')
